    ...
    <div className="mt-4 flex items-center justify-center text-slate-800 relative">
        <div className="">
            <span className='flex flex-col items-center justify-center  '>
                ...
                <span className='text-4xl font-semibold text-center text-orange-600  '>Coimbatore</span>
            </span>
            <div className='text-3xl font-bold text-center mt-2   '>20°C</div>
        </div>
        ...
        <div className="absolute top-0 left-0 p-3 text-center text-xl font-semibold">
                ...
                Longitude <br /><span className='text-2xl '>0</span>
        </div>
